...
// An event from the atproto firehose
//
// This represents the schema of data sent to the `firehose-event` subject.
type FirehoseEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Did           string                 `protobuf:"bytes,1,opt,name=did,proto3" json:"did,omitempty"`
	Timestamp     *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Kind          EventKind              `protobuf:"varint,3,opt,name=kind,proto3,enum=testproto.EventKind" json:"kind,omitempty"`
...
type Commit struct {
	...
	Operation     CommitOperation        `protobuf:"varint,2,opt,name=operation,proto3,enum=testproto.CommitOperation" json:"operation,omitempty"`
...
const file_testproto_proto_rawDesc = "" +
	"\n" +
	"\x0ftestproto.proto\x12\ttestproto\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfe\x01\n" +
	"\rFirehoseEvent\x12\x18\n" +
	"\x03did\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03did\x12@\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\ttimestamp\x120\n" +
	"\x04kind\x18\x03 \x01(\x0e2\x14.testproto.EventKindB\x06\xbaH\x03\xc8\x01\x01R\x04kind\x12)\n" +
	"\x06commit\x18\x04 \x01(\v2\x11.testproto.CommitR\x06commit\x12\x18\n" +
	"\aaccount\x18\x05 \x01(\fR\aaccount\x12\x1a\n" +
	"\bidentity\x18\x06 \x01(\fR\bidentity\"\xb2\x01\n" +
	"\x06Commit\x12\x10\n" +
	"\x03rev\x18\x01 \x01(\tR\x03rev\x128\n" +
	"\toperation\x18\x02 \x01(\x0e2\x1a.testproto.CommitOperationR\toperation\x12\x1e\n" +
	"\n" +
	...
	"\x17COMMIT_OPERATION_DELETE\x10\x03Bq\n" +
	"\rcom.testprotoB\x0eTestprotoProtoP\x01Z\f./;testproto\xa2\x02\x03TXX\xaa\x02\tTestproto\xca\x02\tTestproto\xe2\x02\x15Testproto\\GPBMetadata\xea\x02\tTestprotob\x06proto3"
...
var file_testproto_proto_goTypes = []any{
	(EventKind)(0),                // 0: testproto.EventKind
	(CommitOperation)(0),          // 1: testproto.CommitOperation
	(*FirehoseEvent)(nil),         // 2: testproto.FirehoseEvent
	(*Commit)(nil),                // 3: testproto.Commit
	(*Cursor)(nil),                // 4: testproto.Cursor
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_testproto_proto_depIdxs = []int32{
	5, // 0: testproto.FirehoseEvent.timestamp:type_name -> google.protobuf.Timestamp
	0, // 1: testproto.FirehoseEvent.kind:type_name -> testproto.EventKind
	3, // 2: testproto.FirehoseEvent.commit:type_name -> testproto.Commit
	1, // 3: testproto.Commit.operation:type_name -> testproto.CommitOperation
